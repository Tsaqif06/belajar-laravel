...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
                ...
                <form action="/register" method="post">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control rounded-top @error('name') is-invalid @enderror"
                            id="name" name="name" placeholder="Darren Watkins" value="{{ old('name') }}" required>
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control @error('username') is-invalid @enderror" id="username"
                            name="username" placeholder="Darren" value="{{ old('username') }}" required>
            ...
            <small class="d-block text-center mt-3 text-muted">Already Registered? <a href="/login">Login!</a></small>
        </div>
    </div>
